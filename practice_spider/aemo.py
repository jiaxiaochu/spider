...
# import requests
#
# start_url = "https://wordpress-edu-3autumn.localprod.oc.forchange.cn/wp-login.php"
# headers = {
...
#     "testcookie": "1"
# }
# login_in = requests.get(url=start_url, headers=headers, data=data)
# # print(login_in)
# cookies = login_in.cookies
# print(cookies)
# url_2 = 'https://wordpress-edu-3autumn.localprod.oc.forchange.cn/wp-comments-post.php'
# data_2 = {
#     "comment": input("请输入你想要可发表的评论："),
#     "submit": "发表评论",
#     "comment_post_ID": "13",
#     "comment_parent": "0"
# }
# comment = requests.post(url_2, headers=headers, data=data_2, cookies=cookies)
